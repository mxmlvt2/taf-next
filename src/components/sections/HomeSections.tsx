...
const BLOG_POSTS_PL = [
  ...
  { slug: 'porownanie-zamkow-blyskawiacznych-metalowe-plastikowe-i-nylonowe', title: 'Porównanie Zamków Błyskawicznych: Metalowe, Plastikowe i Nylonowe', excerpt: 'Z założenia dosyć prosty mechanizm zamka błyskawicznego jest komponentem złożonym, zależnym od materiału z którego został wykonany.', date: '2025-06-20', img: 'https://trimsandfasteners.com/wp-content/uploads/2025/06/metalslider34-scaled.jpg' },
  { slug: 'jak-rozwiazac-problemy-z-zamkiem-blyskawiacznym', title: 'Jak rozwiązać problemy z zamkiem błyskawicznym?', excerpt: 'Nie ma nic bardziej irytującego niż zamek błyskawiczny, który odmawia współpracy w najmniej odpowiednim momencie.', date: '2025-05-23', img: 'https://trimsandfasteners.com/wp-content/uploads/2025/06/plastikowyzielony-1.jpg' },
];
