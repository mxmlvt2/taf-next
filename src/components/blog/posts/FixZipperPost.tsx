  ...
  return (
    <div className="prose prose-gray max-w-none font-[Jost]">
      ...
      <p>{isEn
        ...
        : 'Oferujemy zamki ognioodporne i wodoodporne, a także specjalistyczne rozwiązania dla branży outdoorowej, odzieżowej i technicznej. Jeśli jesteś projektantem, producentem lub po prostu szukasz zamków do wymagającego projektu – porozmawiaj z nami. Pomożemy dobrać rozwiązanie, które sprawdzi się niezawodnie przez długi czas, nawet w trudnych warunkach.'
      }</p>
    </div>
  );
}
