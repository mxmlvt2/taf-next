...
export default function QualityZipperPost({ locale }: Props) {
  ...
  return (
    <div className="prose prose-gray max-w-none font-[Jost]">
      ...
      <h2 id="customer-satisfaction">{isEn ? 'The Connection Between Zipper Quality and Customer Satisfaction' : 'Wybór zamków odpowiedniej jakości a zadowolenie klientów'}</h2>
      <p>{isEn
      ...
      <p>{isEn
        ...
        : 'W TAF wiemy, że zamek może decydować o sukcesie lub porażce produktu. Jako dystrybutor zamków błyskawicznych współpracujemy wyłącznie z zaufanymi producentami, którzy używają najlepszych technologii i materiałów. Doradzamy naszym klientom rozwiązania idealnie dopasowane do rodzaju odzieży, akcesoriów lub sprzętu, który tworzą. Możemy pomóc Ci dobrać odpowiedni typ zamka do:'
      }</p>
      <ul>
      ...
      <p>{isEn
        ...
        : 'Chcesz mieć pewność, że Twoi klienci będą zadowoleni z jakości, funkcjonalności i trwałości Twoich produktów? Skontaktuj się z nami. Doradzimy, podzielimy się doświadczeniem i zadbamy o to, by Twoje produkty działały bez zarzutu.'
      }</p>
    </div>
  );
}
